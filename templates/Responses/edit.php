 ...
 * @var string[]|\Cake\Collection\CollectionInterface $assessments
	...
	<div class="col-2 text-end">
		<div class="dropdown mx-3 mt-2">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $response->id), 'class' => 'dropdown-item', 'escapeTitle' => false]
            ) ?>
