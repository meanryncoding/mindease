        ...
        <div class="dropdown mx-3 mt-2">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <?= $this->Form->postLink(
                    ...
                    ['action' => 'delete', $counselorNote->id],
                    ['confirm' => __('Are you sure you want to delete this note?'), 'class' => 'dropdown-item text-danger', 'escapeTitle' => false]
                ) ?>
            </div>
        </div>
    </div>
...
<div class="card border-0 shadow mb-4" style="border-radius:12px;">
    <div class="card-body p-4">
        ...
        <div class="text-end mt-3 d-flex justify-content-end gap-2">
            <?= $this->Html->link('<i class="fa-solid fa-arrow-left me-1"></i> Back', ['action' => 'index'], ['class' => 'btn btn-outline-secondary', 'escape' => false]) ?>
            <?= $this->Form->button('<i class="fa-solid fa-floppy-disk me-1"></i> Save Changes', [
                'type'        => 'submit',
